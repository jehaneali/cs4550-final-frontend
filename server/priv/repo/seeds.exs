...
_p2 = Inject.rep(52833,gigi.id)
_p3 = Inject.rep(52900,gigi.id)
_p4 = Inject.rep(53015,gigi.id)
_p1 = Inject.rep(52857,gigi.id)
_p5 = Inject.rep(52862,gigi.id)
_p6 = Inject.rep(52993,gigi.id)
